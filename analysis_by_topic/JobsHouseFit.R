...
Sum_PUMS <- pums %>%
  ...
  select(SERIALNO,SPORDER,Industry,PUMA,County_Res,POWPUMA,County_Emp,PWGTP,AGEP,JWTR,HINCP,adjustedinc,agerc,incomerc,incomeLW,racerc,RELP) #if using calif instead of bayarea there is no PUMA_Name
