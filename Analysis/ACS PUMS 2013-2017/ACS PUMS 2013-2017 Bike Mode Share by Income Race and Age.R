# ACS PUMS 2013-2017 Bike Mode Share by Income Race and Age.R
...
write.csv(incomesum, "PUMS2013-2017 Bike Commuters by Income.csv", row.names = FALSE, quote = T)
write.csv(racesum, "PUMS2013-2017 Bike Commuters by Race.csv", row.names = FALSE, quote = T)
write.csv(agesum, "PUMS2013-2017 Bike Commuters by Age.csv", row.names = FALSE, quote = T)
