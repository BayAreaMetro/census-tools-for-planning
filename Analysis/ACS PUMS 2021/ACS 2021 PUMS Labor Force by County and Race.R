# ACS 2021 PUMS Labor Force by County and Race.R
...
write.csv(sum.total, paste0(OUTPUT, "ACS PUMS 2021 Labor Force by County and Race.csv"), row.names = FALSE, quote = T)
