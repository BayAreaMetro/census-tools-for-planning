# ACS 2015-2019 PUMS Federal Poverty by County.R
...
# Script to extract 2019 persons by poverty
# including recoded variable names 

bay_poverty <- get_pums(
  variables = c("PUMA","RAC1P", "HISP", "POVPIP"),
                survey = "acs5",
                state = "CA",
                year = 2019,
                recode = TRUE) %>% 
...
write.csv(final,file = "M:/Data/Requests/Lysa Hale/Clipper Start/Poverty and Race for Totals by county.csv",row.names = F)
